      ...
      <section className="about container" style={{ padding: '0 24px' }}>
        <div id="sobre1">
          ...
          >
            ...
            <FancyButton
              href="https://drive.google.com/file/d/1l08M4ZY2tYSw-hhDQDjXaV7ocJj00fyB/view"
              variant="secondary"
            >
              Leia o 1º capítulo
            </FancyButton>
            <FancyButton href="https://www.youtube.com/watch?v=TbypwQxNwaY">
              booktrailer
            </FancyButton>
            <FancyButton
              href="https://music.youtube.com/playlist?list=PLx8pfCgphZXmLTHzG78blHcLobHQCz385"
              variant="secondary"
            >
              Trilha sonora
            </FancyButton>
